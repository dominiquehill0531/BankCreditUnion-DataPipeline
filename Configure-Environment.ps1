...
{
    Write-Host "== Did not find expected resource file at Development\requirements.txt. " + "Verify you are executing this script at the correct location, exiting..." -ForegroundColor Red
    return
}
...
$virtualEnv = "$env:USERPROFILE\Development\.venv"
